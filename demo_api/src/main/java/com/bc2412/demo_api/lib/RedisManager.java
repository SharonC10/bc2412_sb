package com.bc2412.demo_api.lib;
...
public class RedisManager {
  ...
  //json == null (if json = null) ? (1)出null ; (2)objectMapper read value (json, clazz)
  //!objectMapper --> json -> Object or Object -> json
  ...
  public void set(String key, Object object) throws JsonProcessingException {
    ...
    this.redisTemplate.opsForValue().set(key, serializedJson, DEFAULT_DURATION);//default 1hour
  }
